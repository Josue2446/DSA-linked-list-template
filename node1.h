...
namespace main_savitch_5{
    ...
    template <class value_type>
    void list_head_insert(node<value_type>*& head_ptr, 
                          const value_type& entry);

    template <class value_type> 
    void list_insert(node<value_type>* previous_ptr, 
                     const value_type& entry);

    template <class value_type>
    node<value_type>* list_search(node<value_type>* head_ptr, 
    ...
    template <class value_type>
    node<value_type>* list_locate(node<value_type>* head_ptr, 
                                  std::size_t position);

    template <class value_type>
    const node<value_type>* list_locate(const node<value_type>* head_ptr, 
                                        std::size_t position);
    ...
    template <class value_type>
    void list_copy(const node<value_type>* source_ptr, 
                   node<value_type>*& head_ptr, node<value_type>*& tail_ptr);
}

#include "node1.template" // Include the implementation
#endif
